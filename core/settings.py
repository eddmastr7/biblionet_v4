...
TEMPLATES = [
    {
        ...
        # Por si usas una carpeta 'templates' a nivel proyecto
...
# Directorio donde tienes tus archivos estáticos del proyecto
STATICFILES_DIRS = [
    BASE_DIR / "static",
]

# Directorio a donde collectstatic copiará todo (para producción / docker)
STATIC_ROOT = BASE_DIR / "staticfiles"

# Media (portadas, imágenes subidas)
MEDIA_URL = "/media/"
